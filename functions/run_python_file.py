...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description="Executes a python file with the specified args, constrained to the working directory.",
    parameters=types.Schema(
        ...
        properties={
            ...
            "args": types.Schema(
                type=types.Type.STRING,
                description="The list of arguments passed to the Python file to be executed.",
            ),
        },
    ),
)  
